                ...
                <div class="modal-content">
                    <Form @submit="submitContact" :validation-schema="SignInSchema">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="job1" class="col-form-label">Nghề nghiệp:</label>
                                <Field name="job" id="job1" as="select" class="form-control"
                                    v-model="contactSignIn.job" >
                                    <option value=""></option>    
